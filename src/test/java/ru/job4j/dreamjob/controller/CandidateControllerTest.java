...
class CandidateControllerTest {
    ...
    public void whenRequestCandidateListPageThenGetPageWithCandidate() {
        var candidate1 = new Candidate(1, "name1", "desc1", now(), false, 4, 2);
        var candidate2 = new Candidate(2, "name2", "desc2", now(), true, 1, 1);
    ...
    public void whenPostCandidateWithFileThenSameDataAndRedirectToCandidatesPage() throws Exception {
        var candidate = new Candidate(1, "name1", "desc1", now(), false, 2, 1);
    ...
    public void whenSomeExceptionThrownThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Кандидат с указанным идентификатором не найдена");
